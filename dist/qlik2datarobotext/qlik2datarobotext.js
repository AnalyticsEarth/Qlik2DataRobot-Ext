...
exports.default = ['$scope', '$element', function ($scope, $element) {
  ...
  $scope.createProject = function (apitoken) {
    ...
    $scope.app.model.engineApp.checkExpression(qlikcall).then(function (check) {
      if (check.qErrorMsg !== "") {
