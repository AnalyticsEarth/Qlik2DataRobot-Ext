...
export default ['$scope', '$element', function($scope, $element) {
  ...
  $scope.activeVisField = "";
  $scope.activeVisDomId = "";
  ...
  $scope.refreshVisualization = (() => {
    if($scope.activeVisField != "" && $scope.activeVisDomId != ""){
      $scope.createVisualization($scope.activeVisField, $scope.activeVisDomId);
    }
  ...
  $scope.createVisualization = ((field, domid) => {
    ...
    $scope.activeVisField = field;
    $scope.activeVisDomId = domid;
